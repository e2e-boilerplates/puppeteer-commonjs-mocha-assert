...
Puppeteer end-to-end test automation boilerplate, Using [Commonjs](https://requirejs.org/docs/commonjs.html), [Mocha](https://mochajs.org) and [Commonjs](https://nodejs.org/api/assert.html).
